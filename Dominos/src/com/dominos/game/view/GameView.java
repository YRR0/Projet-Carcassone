...
public class GameView extends JPanel {
    ...
    private void initComponents(int nbJoueurs) {
        ...
        piocher = new JButton(new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/dominos.jpg"))));
    ...
    public void sacVide() {
        piocher.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/images/empty.png"))));
    }
