...
public class TerminalController {
    ...
    public void lancer() {
        ...
        while(nbJoueurs > 0) {
            ...
            JoueurArtificiel jia = new JoueurArtificiel();
            joueurs.add(jia);
            nbJoueurs--;
            }
            else {
            ...
            for(Joueur j : joueurs) {
                ...
                do {
                    ...
                    if(t.corresponds(plateau, lin, col)) {
    					...
    					if(col+1<plateau.getCases()[lin].length) {
    						c2 = plateau.getTuile(lin, col+1) == null;
    					}
    					if(lin+1<plateau.getCases().length) {
            	...
            	// Cas du joueur artificiel 
            		...
            		System.out.println(t);
            		if(jouer) {
            			int li = ia.getChoix().i;
            			int co = ia.getChoix().j;
            			int tour = ia.getChoix().tour;
            			
            			ia.tourner(t, tour);
            			System.out.println("-> Voici la tuile de l'intelligence artificiel el apres les tours : "+tour);
            			...
            			if(t.corresponds(plateau, li, co)) {
        					...
        					if(co+1<plateau.getCases()[li].length) {
        						c2 = plateau.getTuile(li, co+1) == null;
        					}
        					if(li+1<plateau.getCases().length) {
