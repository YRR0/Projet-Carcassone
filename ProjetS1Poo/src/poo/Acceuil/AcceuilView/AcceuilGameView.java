...
public class AcceuilGameView extends JFrame {
	    ...
	    public AcceuilGameView() {
	        ...
	        panel1 = new ImagePanel("Resources/images/R.jpg",0,0); panel1.setLayout(null); 
	        panel2 = new ImagePanel("Resources/images/c2.jpg",70,70); panel2.setLayout(null);
	        
	        BufferedImage image = null , image2 = null;
	        try {
				image = ImageIO.read(new File("Resources/images/button1.png"));
				image2 = ImageIO.read(new File("Resources/images/button3.png"));
	        } catch (IOException e) {
