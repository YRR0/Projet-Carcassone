...
public class PlayerSelectionView extends JFrame {
	...
	public void creationImage() {
		 try {
			image1 = ImageIO.read(new File("Resources/images/joueur2.png"));
			image2 = ImageIO.read(new File("Resources/images/joueur3.png"));
			image3 = ImageIO.read(new File("Resources/images/joueur4.png"));
			image4 = ImageIO.read(new File("Resources/images/Ok.png"));
		 } catch (IOException e) {
